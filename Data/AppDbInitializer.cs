    ...
    public class AppDbInitializer
    {
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                //Cinema
                if (!context.AllCinemas.Any())
                {
                    context.AllCinemas.AddRange(new List<Cinema>()
                    {
                        new Cinema()
                        {
                            Name = "Cinema 1",
                ...
                //Actors
                if (!context.AllActors.Any())
                {
                    context.AllActors.AddRange(new List<Actor>()
                    {
                        new Actor()
                        {
                            FullName = "Actor 1",
                ...
                //Producers
                if (!context.AllProducers.Any())
                {
                    context.AllProducers.AddRange(new List<Producer>()
                    {
                        new Producer()
                        {
                            FullName = "Producer 1",
                ...
                {
                    context.AllMovies.AddRange(new List<Movie>()
                    {
                        new Movie()
                        {
                            Name = "Life",
                ...
                //Actors & Movies
                if (!context.AllActors_Movies.Any())
                {
                    context.AllActors_Movies.AddRange(new List<Actor_Movie>()
                    {
                        new Actor_Movie()
                        {
                            ActorId = 1,
